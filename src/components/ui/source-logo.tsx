  ...
  const getLogoComponent = (sourceName: string) => {
    switch (sourceName.toLowerCase()) {
      case "google analytics":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b7280F9AB00" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
            <path fill="#6b728034A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
            <path fill="#6b7280FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
            <path fill="#6b7280EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
          </svg>
        );
      ...
      case "hubspot":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b7280FF7A59" d="M18.164 7.931V5.61a1.611 1.611 0 1 0-3.223 0v2.321a5.612 5.612 0 0 0-3.302 1.471l-3.222-3.222a1.611 1.611 0 1 0-2.278 2.278l3.222 3.222a5.612 5.612 0 0 0 1.471 3.302H8.511a1.611 1.611 0 1 0 0 3.223h2.321a5.612 5.612 0 0 0 10.055-3.222 5.612 5.612 0 0 0-2.723-4.832z"/>
          </svg>
        );
      ...
      case "stripe":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b7280635BFF" d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.274 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.591-7.305z"/>
          </svg>
        );
      ...
      case "gmail":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b7280" d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636.302 0 .587.083.832.228L12 10.773l9.532-6.724c.245-.145.53-.228.832-.228.904 0 1.636.732 1.636 1.636z"/>
          </svg>
        );
      ...
      case "slack":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b7280" d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52z"/>
            <path fill="#6b728036C5F0" d="M6.313 15.165a2.527 2.527 0 0 1 2.521-2.52 2.527 2.527 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.522v-6.313z"/>
            <path fill="#6b72802EB67D" d="M8.834 5.042a2.528 2.528 0 0 1-2.521-2.52A2.528 2.528 0 0 1 8.834 0a2.528 2.528 0 0 1 2.521 2.522v2.52H8.834z"/>
            <path fill="#6b7280ECB22E" d="M8.834 6.313a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312z"/>
          </svg>
        );
      ...
      case "outlook":
        return (
          <svg viewBox="0 0 24 24" className={className}>
            <path fill="#6b72800078D4" d="M7.462 10.462c0-1.846 1.077-3.077 2.769-3.077s2.769 1.231 2.769 3.077-1.077 3.077-2.769 3.077-2.769-1.231-2.769-3.077zm-1.846 0c0 2.769 1.846 4.615 4.615 4.615s4.615-1.846 4.615-4.615S13 5.846 10.231 5.846s-4.615 1.846-4.615 4.615z"/>
            <path fill="#6b72800078D4" d="M0 4.615v14.77h24V4.615H0zm22.154 13.077H1.846V6.462h20.308v11.23z"/>
          </svg>
        );
