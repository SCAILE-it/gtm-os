  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        ...
        <div 
          className="border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#2A2D3A] flex flex-shrink-0 relative"
        ...
        <div 
          className="border-l border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#2A2D3A] flex flex-col flex-shrink-0 relative"
                  ...
                  {workspaceItems.length > 0 && (
                    <div className="space-y-3">
                      {workspaceItems.map((item) => (
                        <div key={item.id} className="p-3 bg-white dark:bg-[#363A4A] rounded border border-gray-200 dark:border-gray-600">
